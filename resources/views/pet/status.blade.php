<div class="dropdown">
	...
	@if($status == 'Recuperado' && $avaible =="disponible")
	...
	@elseif($status == 'Recuperado' && $avaible != "disponible")
		<button class="btn btn-success btn-sm btn-block" type="button" id="dropdownMenuButton" aria-haspopup="true" aria-expanded="false"> Recuperado
		</button>
